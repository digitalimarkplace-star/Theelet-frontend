        ...
        <ScrollFadeIn>
          ...
          <form onSubmit={submit} className="mt-10 text-left">
            ...
            <div className="mt-8">
              ...
              <p className="mt-1 text-sm text-ink-soft">pick any. helps us send less, better.</p>
                    ...
                    <button
                      ...
                      className={`rounded-full border px-4 py-2 text-sm transition-colors ${
                        selected
                          ...
                          : "border-ink/20 bg-transparent text-ink-soft hover:border-teal hover:text-ink"
                      }`}
                    >
